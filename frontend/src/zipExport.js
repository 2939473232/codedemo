...
export function createExportReadme(manifest) {
  return [
    ...
    '',
    `Engine: ${manifest.project.targetEngine}`,
    `Style: ${manifest.project.artStyle}`,
    `Assets: ${manifest.summary.total}`,
    '',
    'This package was generated by SpriteForge fallback export.',
    'SVG files are lightweight previews for the prototype; later ZIP export can swap them for PNG output.',
    ''
  ].join('\n');
}
